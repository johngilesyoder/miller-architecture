		...
		<div class="row">
			<div class="col-md-8 col-md-push-4">
				<div class="row">
					...
					<div class="col-md-4 ml-badge">
						<a href="http://www.mountainliving.com/People/The-ML-List-Top-Architects-Designers-2019/" target="_blank">
							<img alt="Mountain Living's 2019 Top Mountain Architects &amp; Designers" src="<?php echo get_template_directory_uri(); ?>/assets/img/badge-ml.png?v=2019" />
						</a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-7">
				<div class="footer-social">
					<a href="http://pinterest.com/millerarchitect/" target="_blank">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-pinterest.svg" />
					</a>
					<a href="http://www.houzz.com/pro/ctm7057/miller-architects-ltd" target="_blank">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-houzz.svg" />
					</a>
					<a href="https://plus.google.com/102393456806890657332" target="_blank">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-googleplus.svg" />
					</a>
					<a href="http://www.facebook.com/MillerArchitectsPc" target="_blank">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-facebook.svg" />
					</a>
					<a href="http://www.twitter.com/CMarchitectsMT" target="_blank">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-twitter.svg" />
					</a>
				</div>
			</div>
		</div>
